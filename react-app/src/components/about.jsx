            ...
            <div className="row">
                <div className="col-12 col-md-8 mb-2 mb-md-0">
                    ...
                    <p style={{fontSize: 'clamp(0.9rem, 1.5vw, 1rem)'}}>
                        ...
                        <span style={{color: "#3674B5", fontWeight:700}}>PNJ</span> dan <span style={{color: "#3674B5", fontWeight:700}}>IMERI UI</span>, dengan dukungan penuh dari para ahli di berbagai bidang. 
